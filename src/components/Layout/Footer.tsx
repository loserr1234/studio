    ...
    <footer ref={footerRef} className="w-full py-20 md:py-32 px-6 bg-background border-t border-white/5 relative z-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="footer-meta flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button onClick={scrollToTop} className="text-white/40 hover:text-accent transition-colors duration-300 text-sm flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-sm bg-transparent border-none">
            Back to top
